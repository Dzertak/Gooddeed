...
public class SubscriptionsSettingsFragment extends PreferenceFragmentCompat {
    ...
    public final static String TAG = SubscriptionsSettingsFragment.class.getName();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        findPreference(PREFERENCE_CATEGORY_KEY).setOnPreferenceClickListener(preference -> {
            ...
            NavDirections action
                    = SubscriptionsSettingsFragmentDirections.actionSubscriptionsSettingsFragmentToCategoryNavGraph(TAG);
